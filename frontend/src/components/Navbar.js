...
const Navbar = () => {
  ...
  return (
    <nav className="fixed left-0 top-0 h-full w-64 bg-surface border-r border-slate-200 p-4 flex flex-col z-50">
      <div className="flex items-center gap-3 mb-10 px-2">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center text-slate-900 font-bold text-xl">
          F
        </div>
